...
# folders with these names will be ignored completely
CORE_IGNORES = {
...
# files with these names will be ignored completely
CORE_IGNORE_FILES = {}

# content of files with these formats will be skipped but will appear in the folder tree
CORE_SKIP_EXTS = {
    # Data & Databases
